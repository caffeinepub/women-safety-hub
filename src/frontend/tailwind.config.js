  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        card: "0 4px 16px rgba(43,18,54,0.08), 0 1px 4px rgba(43,18,54,0.04)",
        "card-hover": "0 12px 32px rgba(43,18,54,0.15), 0 4px 8px rgba(43,18,54,0.08)",
        pink: "0 4px 16px rgba(243,160,168,0.35)",
      },
      keyframes: {
